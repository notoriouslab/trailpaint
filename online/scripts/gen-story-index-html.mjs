...
const GROUPS = ['paul', 'xuanzang', 'zheng-he', 'jesus-galilee', 'zhang-qian', 'wen-tianxiang', 'marco-polo', 'xu-xiake', 'revelation-churches', 'exodus-conquest', 'david-king', 'babylon-exile-return', 'jesus-birth', 'early-church'];
